    ...
    def __init__(self, config, **kwargs):
        ...
        self.last_layer = nn.Sequential(
            ...
            nn.Conv2d(
                ...
                kernel_size=config['MODEL']['BACKBONE']['FINAL_CONV_KERNEL'],
                stride=1,
                padding=1 if config['MODEL']['BACKBONE']['FINAL_CONV_KERNEL'] == 3 else 0)
        )
...
def get_seg_model(cfg_path, num_classes):
